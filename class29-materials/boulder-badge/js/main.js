...
let bulbaCandies = 16 - 5
let caterCandies = 7 - 1
let weedleCandies = 7 - 1
let totalCandies = bulbaCandies + caterCandies + weedleCandies
...
function battleParty (opponentPartyNum) {
    for (let i = 1; i <= opponentPartyNum; i++){
